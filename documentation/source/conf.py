...
latex_documents = [
    (master_doc, 'antiweb.tex', 'antiweb Documentation',
     'Philipp Rathmanner', 'manual'),
]
...
man_pages = [
    (master_doc, 'antiweb', 'antiweb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'antiweb', 'antiweb Documentation',
     author, 'antiweb', 'One line description of project.',
     'Miscellaneous'),
]
...
#Adding support for Graphviz Diagrams
#graphviz_dot='dot.exe'
